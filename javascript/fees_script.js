function getInputValue(){
    ...
    {
        document.getElementById("demo").innerHTML ="ACHYUTA MOHAPATRA";
        document.getElementById("demo1").innerHTML ="10000"; 
    }
    else if(inputVal==09)
    {
        document.getElementById("demo").innerHTML ="VIRAT ROY";
        document.getElementById("demo1").innerHTML ="20000"; 
    }
    else if(inputVal==28)
    {
        document.getElementById("demo").innerHTML ="AISHIK GHOSH";
        document.getElementById("demo1").innerHTML ="6000"; 
    }
    else{
        document.getElementById("demo").innerHTML ="No Records Found";
        document.getElementById("demo1").innerHTML ="0";
